...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:admin'])->group(function () {
        ...
        // Master Pekerjaan (hierarki 3 level)
        Route::resource('master-pekerjaans', MasterPekerjaanController::class);
        Route::resource('master-pekerjaans.details', DetailPekerjaanController::class)
            ->only(['store', 'update', 'destroy'])
            ->parameters(['details' => 'detail', 'master-pekerjaans' => 'masterPekerjaan']);
        Route::resource('detail-pekerjaans.materials', DetailMaterialController::class)
            ->only(['store', 'update', 'destroy'])
            ->parameters(['materials' => 'material', 'detail-pekerjaans' => 'detailPekerjaan']);
    });
